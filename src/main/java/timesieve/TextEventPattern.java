 ...
 * (Tense=PAST, Aspect=PROGRESSIVE) representing all past progressive TextEvents.
 * 
 * This is useful in constructing rules about text events based on their attribrutes.
 * 
 * @author Bill
 *
 */
public class TextEventPattern implements Serializable {
	...
	public void setFromCanonicalEvent(TextEvent canonicalEvent, boolean keepClass, boolean keepTense, boolean keepAspect) {
		if (keepClass)
	...
	public boolean equals(Object o) {
		...
		return p.theClass == this.theClass && p.tense == this.tense && p.aspect == this.aspect;
	}
