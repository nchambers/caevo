...
public interface Sieve {
	 ...
	 * 
	 * @param info The pre-processed document information for a set of documents. We assume 
	 *             that it includes all events and timexes, parse trees, and dependencies.
	 * @param docname The name of a single document that exists in the given InfoFile.
